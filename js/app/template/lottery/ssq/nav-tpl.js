define(['handlebars'], function (Handlebars) {
	...
	return templates['nav'] = template(function (Handlebars, depth0, helpers, partials, data) {
			...
			if (helper = helpers.issue) {
				stack1 = helper.call(depth0, {
						hash : {},
						data : data
					});
			} else {
				helper = (depth0 && depth0.issue);
				stack1 = typeof helper === functionType ? helper.call(depth0, {
						hash : {},
						data : data
					}) : helper;
			...
			stack1 = helpers['if'].call(depth0, (depth0 && depth0.logined), {
					hash : {},
