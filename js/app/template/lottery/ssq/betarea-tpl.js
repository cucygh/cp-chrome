define(['handlebars'], function (Handlebars) {
	...
	return templates['betarea'] = template(function (Handlebars, depth0, helpers, partials, data) {
			...
			function program1(depth0, data) {
				...
				buffer += escapeExpression(stack1)
				 + "</button>\r\n		<em class=\"yl\">";
				if (helper = helpers.yl) {
					stack1 = helper.call(depth0, {
							hash : {},
							data : data
						});
				} else {
					helper = (depth0 && depth0.yl);
					stack1 = typeof helper === functionType ? helper.call(depth0, {
							hash : {},
							data : data
						}) : helper;
			...
			if (helper = helpers.red) {
				stack1 = helper.call(depth0, options);
			} else {
				helper = (depth0 && depth0.red);
